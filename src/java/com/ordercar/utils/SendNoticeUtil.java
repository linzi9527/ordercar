...
public class SendNoticeUtil {
	...
	public static final String CHQXYUTX = "CHQXYUTX";//客户取消预约车辆提醒信息
		...
		if(null != jsonObject && !jsonObject.isEmpty()){
			...
			if(StringUtils.isNotEmpty(access_token)){
				...
				if(StringUtils.isNotEmpty(type)){
					...
					if(CHQXYUTX.equals(type)){
						wxReturnObject = CommonUtil.httpsRequest(requestUrl1, "GET", cancelRecordPushSendOffTemplate(info, url).toString());
						System.out.println(wxReturnObject);
						log.info("微信模板推送公用方法："+wxReturnObject);
					}
				}
	...
	private static Object recordPushSendOffTemplate(Map<String, Object> info,String url) {
	       JSONObject jsonObject = new JSONObject();
	        ...
	        jsonObject.put("template_id", "SVo-SaktOtPyviMM2J9WU9tt18GghTwsn0Ver4-2bKs"); //模板ID
	 ...
	 * @return
	 */
	private static Object cancelRecordPushSendOffTemplate(Map<String, Object> info,String url) {
		JSONObject jsonObject = new JSONObject();
		jsonObject.put("touser", info.get("openId"));
		jsonObject.put("template_id", "dbhipoMRPWb2LaJod_mjSjrXZQ3uFBT6Cp2Giv6qhLA"); //模板ID
		if(StringUtils.isNotEmpty(url)){
			jsonObject.put("url", url); //详情页面url是可选参数，不进行跳链
		}
		jsonObject.put("topcolor", "#FF0000");
	...
	public static void main(String args[]){
		...
		infoMap.put("keyword1", "张三");
		infoMap.put("keyword2", "白鹿驾校科二 2号车 C1");
		infoMap.put("keyword3", "2014年10月16日  7：30-9：30");
		infoMap.put("keyword4", "无");
		infoMap.put("remark", "请知悉，感谢您的支持！");
		SendNoticeUtil.SendNotice(infoMap, "CHQXYUTX", "","wx9766e4b2a8cb0844","53a60d01dace6a93fdb829f9d8fbbc7d");
	}
}
